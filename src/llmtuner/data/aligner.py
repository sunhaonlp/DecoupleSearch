...
def convert_mcts(examples: Dict[str, List[Any]], dataset_attr: "DatasetAttr") -> Dict[str, List[Any]]:
    outputs = {"messages": []}
    for i in range(len(examples['messages'])):
        outputs['messages'].append(examples['messages'][i])
...
def align_dataset(
    ...
    convert_func = partial(convert_mcts, dataset_attr=dataset_attr)
